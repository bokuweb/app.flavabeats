...
(function() {
  ...
  this.Game = (function() {
    var _endGameIfTimeOver, _endTime, _fallDist, _game, _generateNote, _getSprite, _music, _note, _noteHeight, _noteWidth, _pool, _poolSprite, _preAllocateNote, _renderTarget, _score, _status, _threshold;
    ...
    _preAllocateNote = function() {
      var i, note, v, _i, _len, _ref;
      _ref = _note.timing;
  ...
  Note = (function() {
    var _fallDist, _game, _gen, _note, _noteHeight, _noteWidth, _preAllocate, _renderDist;
    ...
    Note.prototype.create = function(currentTime) {
      if (_note.timing[_note.index] != null) {
        if (currentTime > (_note.timing[_note.index] - (_fallDist / _note.speed))) {
          return _gen(note.index++);
        }
      }
    };
  ...
  GameSys = (function() {
    ...
    GameSys.getResouce = function(src) {
      return _game.assets[src];
    };
